...
export const PRODUCT_GENDER_LIST_REQUEST = "PRODUCT_GENDER_LIST_REQUEST";
export const PRODUCT_GENDER_LIST_SUCCESS = "PRODUCT_GENDER_LIST_SUCCESS";
export const PRODUCT_GENDER_LIST_FAIL = "PRODUCT_GENDER_LIST_FAIL";
